    ...
    public partial class Switchless : Form
    {
        ...
        private void startOsuClick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    // Exit application.
                    Console.WriteLine("DEBUG: Started osu! at: " + this.osuPath + " on: ainu.pw.");
                    Application.Exit();
                }
            }
        }
        ...
        private void switchlessLabel_Click(object sender, EventArgs e)
        {

        }

        private void creditLabel(object sender, EventArgs e)
        {
            System.Diagnostics.Process.Start("https://github.com/Yo-ru/Switchless/tree/0.3.0");
        }

        private void Switchless_Load(object sender, EventArgs e)
        {
